    ...
    public class Eksempeldata : DropCreateDatabaseIfModelChanges<NettbutikkContext>
    {
        protected override void Seed(NettbutikkContext context)
        {
            ...
            new List<Bilder>
            {
                ...
                new Bilder { Sko = skoene.Single(s => s.Navn == "92-98024"), BildeUrl = "/Pictures/Sko/8425411611_1.jpg" },
                new Bilder { Sko = skoene.Single(s => s.Navn == "92-98024"), BildeUrl = "/Pictures/Sko/8425411611_2.jpg" },
                new Bilder { Sko = skoene.Single(s => s.Navn == "92-98024"), BildeUrl = "/Pictures/Sko/8425411611_4.jpg" },
                new Bilder { Sko = skoene.Single(s => s.Navn == "92-98024"), BildeUrl = "/Pictures/Sko/8425411611_6.jpg" },
                new Bilder { Sko = skoene.Single(s => s.Navn == "Odiin 1625500150"), BildeUrl = "/Pictures/Sko/1625500150_1.jpg" },
                new Bilder { Sko = skoene.Single(s => s.Navn == "Odiin 1625500150"), BildeUrl = "/Pictures/Sko/1625500150_2.jpg" },
                new Bilder { Sko = skoene.Single(s => s.Navn == "Odiin 1625500150"), BildeUrl = "/Pictures/Sko/1625500150_4.jpg" },
                new Bilder { Sko = skoene.Single(s => s.Navn == "Odiin 1625500150"), BildeUrl = "/Pictures/Sko/1625500150_6.jpg" },
                new Bilder { Sko = skoene.Single(s => s.Navn == "ECCO 634504 HAROLD"), BildeUrl = "/Pictures/Sko/1225520531_1.jpg" },
                new Bilder { Sko = skoene.Single(s => s.Navn == "ECCO 634504 HAROLD"), BildeUrl = "/Pictures/Sko/1225520531_2.jpg" },
                new Bilder { Sko = skoene.Single(s => s.Navn == "ECCO 634504 HAROLD"), BildeUrl = "/Pictures/Sko/1225520531_4.jpg" },
                new Bilder { Sko = skoene.Single(s => s.Navn == "ECCO 634504 HAROLD"), BildeUrl = "/Pictures/Sko/1225520531_6.jpg" }
