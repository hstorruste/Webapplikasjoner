        ...
        protected override void Seed(NettbutikkContext context)
        {
            ...
            var skoene = new List<Sko>
            {
                ...
                new Sko { Navn = "Skofus 8415500165", Beskrivelse = "Smart rød Skofus gummistøvle. Støvlen har flotte detaljer på skaftet. Den har en strop bag på skaftet, så den er let at få på.",
                        Merke = merker.Single( m => m.Navn == "Skofus"), Farge = "Rød", Pris = 249.00M, ForHvem = forHvem.Single( f => f.Navn == "Barn"), Kategori = kategorier.Single( k => k.Navn == "Gummistøvler")},
                new Sko { Navn = "ECCO 810204 Xpedition", Beskrivelse = "Flott herrestøvlett fra Ecco i sort oilsemsket skinn med besetninger i andre materialer. Støvletten har sorte lisser. Den har flotte detaljer på sider og på forblad. I tillegg har den Gore-Tex, som holder den vanntett. Innvendig tekstilfôr, utvendig en kraftig profilert gummisåle.",
                        Merke = merker.Single( m => m.Navn == "ECCO"), Farge = "Sort", Pris = 1499.00M, ForHvem = forHvem.Single( f => f.Navn == "Herre"), Kategori = kategorier.Single( k => k.Navn == "TEX-membran")},
                new Sko { Navn = "Tamaris 2-1-26277-23", Beskrivelse = "Varmfôret snørestøvlett med glidelås på innersiden, kraftig gummisåle samt tex-membran som gjør støvletten vannavvisende. Modellen er dekorert med plysjfôr øverst på skaftet.",
                        Merke = merker.Single( m => m.Navn == "Tamaris"), Farge = "Sort", Pris = 899.00M, ForHvem = forHvem.Single( f => f.Navn == "Dame"), Kategori = kategorier.Single( k => k.Navn == "TEX-membran")},
